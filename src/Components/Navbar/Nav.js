...
const Nav = () => {
    ...
    return (
        <nav className={`${show ? 'nav_back' : 'nav_transparent'}`}>
            <section>
                <div className="nav_left">
                    <img className="nav_logo" src="https://upload.wikimedia.org/wikipedia/commons/7/7a/Logonetflix.png" alt="netflixlogo" />
                ...
                <div className="nav_right">
                    ...
                    <img src="https://occ-0-2482-3646.1.nflxso.net/dnm/api/v6/K6hjPJd6cR6FpVELC5Pd6ovHRSk/AAAABY20DrC9-11ewwAs6nfEgb1vrORxRPP9IGmlW1WtKuaLIz8VxCx5NryzDK3_ez064IsBGdXjVUT59G5IRuFdqZlCJCneepU.png?r=229" alt="avatar" />
                </div>
            </section>
        </nav>
    )
